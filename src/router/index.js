  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('../components/Admin/UsersComponent/AdminUsersCreateComponent.vue')
      },
      {
        path: '/Admin/Users/Show/:user',
        name: 'show users',
        meta: { title: 'Show Users' },
        component: () => import('../components/Admin/UsersComponent/AdminUsersShowComponent.vue')
      },
      {
        path: '/Admin/Users/Update/:user',
        name: 'update users',
        meta: { title: 'Update Users' },
        component: () => import('../components/Admin/UsersComponent/AdminUsersUpdateComponent.vue')
      },
      {
        path: '/Admin/Books',
        name: 'books',
        meta: { title: 'Books' },
        component: () => import('../components/Admin/BooksComponent/AdminBooksReadComponent.vue')
      },
      {
        path: '/Admin/Books/Create',
        name: 'create books',
        meta: { title: 'Create Books' },
        component: () => import('../components/Admin/BooksComponent/AdminBooksCreateComponent.vue')
      },
      {
        path: '/Admin/Books/Show/:book',
        name: 'show books',
        meta: { title: 'Show books' },
        component: () => import('../components/Admin/BooksComponent/AdminBooksShowComponent.vue')
      },
      {
        path: '/Admin/Books/Update/:book',
        name: 'update books',
        meta: { title: 'Update Books' },
        component: () => import('../components/Admin/BooksComponent/AdminBooksUpdateComponent.vue')
      },
      {
        path: '/Admin/Subscriptions',
        name: 'subscriptions',
        meta: { title: 'Subscriptions' },
        component: () => import('../components/Admin/SubscriptionsComponent/AdminSubscriptionsReadComponent.vue')
      },
      {
        path: '/Admin/Subscriptions/Create',
        name: 'create subscription',
        meta: { title: 'Create Subscription' },
        component: () => import('../components/Admin/SubscriptionsComponent/AdminSubscriptionsCreateComponent.vue')
      },
      {
